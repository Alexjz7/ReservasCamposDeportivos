...
{
    /// <inheritdoc />
    public partial class MigracionV12 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_deportes = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nombre = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deportes", x => x.id_deportes);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_estadoCancha = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Estado_Canchas", x => x.Id_estadoCancha);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Canchas_Estado_Canchas_id_estadoCancha",
                        column: x => x.id_estadoCancha,
                        principalTable: "Estado_Canchas",
                        principalColumn: "Id_estadoCancha",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Canchas_id_estadoCancha",
                table: "Canchas",
                column: "id_estadoCancha");
